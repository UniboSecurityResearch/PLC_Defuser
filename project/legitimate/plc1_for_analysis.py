...
def plc1():
    ...
    trace.set_value(level, 0, '90')
    trace.set_value(request, 0, '0')
    trace.set_value(level, 1, '30')
    trace.set_value(request, 1, '1')
    trace.set_value(level, 2, '30')
    ...
    for key, value in ctx.nets.items():
        ...
        if 'leq1' == key or 'geq2'==key or 'high_1' == key or 'low_1' == key or 'eq4' == key or 'eq6' == key or \
